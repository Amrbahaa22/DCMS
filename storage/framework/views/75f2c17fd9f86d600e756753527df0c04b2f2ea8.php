	...
	<div class="content-wrapper">
		<section class="content-header">
			...
			<ol class="breadcrumb">
				...
				<li class="active"><?php echo app('translator')->getFromJson('site.doctors'); ?></li>
			</ol>		
		</section><!-- end of content header --> 
		<section class="content">
			<div class="box box-primary">
		    	<div class="box-header with-border">
		    		<h3 class="box-title"  style="margin-bottom: 15px"><?php echo app('translator')->getFromJson('site.doctors'); ?></h3>
		    		...
		    		<form action="" method="">
		    			...
		    			<div class="col-md-4">
		    				...
		    				<a href="<?php echo e(route('users.doctors.create')); ?>" class="btn btn-primary"><i class="fa fa-plus"></i><?php echo app('translator')->getFromJson('site.add'); ?></a>
...
<?php /* C:\xamp\htdocs\Laravel\newproj\resources\views/users/doctors/index.blade.php */ ?>