		...
		<section class="content">
			    <div class="box box-primary">
               		...
               		<div class="box-body">
	               		...
	               		<form action="{{route('users.docpatients.update',$patient->id)}}" method="post">
	               			{{csrf_field()}}
	               			{{method_field('PUT')}}
	               			...
	               			<!-- patient name -->
	               			<div class="form-group">
	               				<label>@lang('site.MedicalHistory')</label>
			                    <div>
			                    <textarea id="compose-textarea" class="form-control text-left" style="height: 100px"  name="MedicalHistory">{{$patient->MedicalHistory}}</textarea>
			                    </div>
	               			</div>
	               			<!-- patient name -->
	               			<div class="form-group">
	               				<label>@lang('site.DentalHistory')</label>
 								<div>
			                    <textarea id="compose-textarea" class="form-control text-left" style="height: 100px"  name="DentalHistory">{{$patient->DentalHistory}}</textarea>
			                    </div>
	               			</div>
	               			<!-- patient name -->
	               			<div class="form-group">
	               				<label>@lang('site.ChiefComplain')</label>
								<div>
			                    <textarea id="compose-textarea" class="form-control text-left" style="height: 100px" name="ChiefComplain">{{$patient->ChiefComplain}}</textarea>
			                    </div>
	               			</div>
