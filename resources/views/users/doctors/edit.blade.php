		...
		<section class="content">
			    <div class="box box-primary">
               		...
               		<div class="box-body">
	               		...
	               		<form action="{{route('users.doctors.update',$user->id)}}" method="post" enctype="multipart/form-data">
	               			{{csrf_field()}}
	               			{{method_field('patch')}}
	               			...
	               			<div class="form-group">
	               				...
	               				<input type="number" name="Incomerate" value="{{$user->Incomerate}}" class="form-control" >
	               			</div>
